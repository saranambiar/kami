...
- When a user explicitly asks for research to be added as Markdown, write the requested documentation in the repository rather than leaving it only in chat or a plan.
