  ...
  return (
    <div className="kraft-card" style={{ padding: "var(--stack-md)", marginBottom: "var(--stack-md)" }}>
      ...
      {planSource === "offline_fallback" && (
        ...
        >
          Hermes unavailable — showing an offline template plan.
          {planNote ? ` ${planNote}` : ""} Start your local Hermes gateway and regenerate.
        </p>
      )}
      {planSource === "hermes" && (
        <p className="mono" style={{ fontSize: 12, color: "var(--ink-soft)", marginBottom: "var(--stack-sm)" }}>
          Plan generated by Hermes sales strategist.
        </p>
      )}
